...
import armchairgreen from "../../../../public/assets/NotLoggedHome/sec9/armchair-green.jpg";
import armchairwindow from "../../../../public/assets/NotLoggedHome/sec9/armchair-window.jpg";
import ashleypink from "../../../../public/assets/NotLoggedHome/sec9/ashley-pink.jpg";
import cabinetwhitewall from "../../../../public/assets/NotLoggedHome/sec9/cabinet-white-wall.jpg";
import candlepurplelavender from "../../../../public/assets/NotLoggedHome/sec9/candle-purple-lavender.jpg";
import earringgems from "../../../../public/assets/NotLoggedHome/sec9/earring-gems.jpg";
import foodyellow from "../../../../public/assets/NotLoggedHome/sec9/food-yellow.jpg";
import laneigewater from "../../../../public/assets/NotLoggedHome/sec9/laneige-water.jpg";
import {
  Dialog,
  DialogContent,
  DialogDescription,
            ...
            <Dialog key={index}>
              <DialogTrigger className="col-span-2 lg:col-span-1 relative group hover:cursor-zoom-in rounded-2xl overflow-hidden">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-5 bg-black/50 text-white flex items-center justify-center">
                  Emerging from rippling water, pink background, shallow depth
                  of field
                </div>
                <Image src={armchairgreen} alt="img" />
              </DialogTrigger>
                  ...
                  <div className="p-10 grid grid-cols-3 gap-5">
                    ...
                    <div className="col-span-3 md:col-span-1 flex flex-col gap-3 text-left">
                      <div className="text-lg font-semibold">
                        Emerging from rippling water, pink background, shallow
                        depth of field
                      </div>
