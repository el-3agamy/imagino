    ...
    <div className="flex flex-col gap-5 pt-20 bg-[#fde047]">
      ...
      <div className="flex flex-wrap justify-center items-center gap-5 px-5">
        {[1, 2, 3, 4, 5, 6, 7, 8].map((item, index) => (
          ...
          >
            <div>
              Pebblely has been a game-changer for my jewelry startup. It allows
              me to create stunning model shots without the cost of hiring
              professionals. I can create images with the right look and feel
              for my brand and then showcase my work beautifully on my website
              and social media.
            </div>
            <hr />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://pebblely.b-cdn.net/samples/auth_bg.jpg')",
        }}
      >
