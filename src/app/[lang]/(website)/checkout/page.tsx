      ...
      <div className="w-full max-w-2xl mx-auto bg-white shadow-xl rounded-3xl p-10 border border-gray-200">
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-3 mt-2">
            ...
            <Button variant="secondary" className="rounded-xl px-6 font-semibold hover:bg-gray-300 hover:text-gray-800">
              Apply
            </Button>
          </div>
        </div>
        ...
        {/* Payment Button */}
        <Button className="bg-main-hover hover:bg-main text-foreground text-xl font-bold w-full py-7 rounded-2xl">
          Pay With Stripe
        </Button>
